...
import starterpack.AI.MoveState.CleverArcherMoveState;
...
public class CleverArcherStrategy implements Strategy {
    ...
    public Position moveActionDecision(GameState gameState, int myPlayerIndex) {
        ...
        CleverArcherMoveState moveState = new CleverArcherMoveState(gameState, myPlayerIndex);
