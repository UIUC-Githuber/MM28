...
import starterpack.AI.MoveState.WizardMoveState2;
import starterpack.AI.UseState.WizardUseState;;

public class WizardStrategy2 implements Strategy {
    ...
    public Position moveActionDecision(GameState gameState, int myPlayerIndex) {
        ...
        //if (myPlayerIndex == 1 || myPlayerIndex == 3)
            return (new WizardMoveState2(gameState, myPlayerIndex).Update());
        //else {
