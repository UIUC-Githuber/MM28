...
public class WizardMoveState2 extends IMoveState{

    public WizardMoveState2(GameState gameState, int playerIndex) {
    ...
    public Position Move() {
        if(Utils.IfCenterInRange(this) && Utils.IfEnemiesInCenter(this)) {
            return getPlayerState().getPosition();
